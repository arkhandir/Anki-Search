...
- [Anki](https://apps.ankiweb.net/) with the AnkiConnect add-on (code `2055492159`)

## Setup

1. In Anki: *Tools → Add-ons → Get Add-ons…*, enter the code `2055492159`, restart Anki.
2. Follow *Notes for macOS Users* in the
   [AnkiConnect documentation](https://foosoft.net/projects/anki-connect/) so Anki
...
The query syntax is the one Anki's browser uses, for example:
